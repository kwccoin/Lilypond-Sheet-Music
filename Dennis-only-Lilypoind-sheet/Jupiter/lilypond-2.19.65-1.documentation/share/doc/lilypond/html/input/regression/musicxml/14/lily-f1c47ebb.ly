...
% ly snippet:
% ****************************************************************
\sourcefilename "/home/gub/NewGub/gub/target/linux-x86/src/lilypond-git.sv.gnu.org--lilypond.git-release-unstable/input/regression/musicxml/99b-Lyrics-BeamsMelismata-IgnoreBeams.xml"
\sourcefileline 0
\version "2.19.65"
...
\header {
    ...
    texidoc = 
    "If we properly ignore all beaming 
